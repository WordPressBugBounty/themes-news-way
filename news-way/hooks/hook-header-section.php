            ...
            ?>
             <div class="col-md-4 col-sm-4 text-center-xs">
                <ul class="mg-social-header-section mg-social info-right">
                      ...
                      <li><span class="icon-soci x-twitter"><a <?php if($newsup_header_twt_target) { ?>target="_blank" <?php } ?>href="<?php echo esc_url($newsup_header_twt_link);?>"><i class="fa-brands fa-x-twitter"></i></a></span></li>
